drop view if exists vw_campaign_negative_keywords_auto_copy_paste cascade;
drop view if exists vw_campaign_negative_keywords_review_copy_paste cascade;
drop view if exists vw_campaign_negative_keywords_auto cascade;
drop view if exists vw_campaign_negative_keywords_review cascade;
drop view if exists vw_campaign_negative_keywords cascade;
drop materialized view if exists mv_campaign_negative_keywords_source cascade;
